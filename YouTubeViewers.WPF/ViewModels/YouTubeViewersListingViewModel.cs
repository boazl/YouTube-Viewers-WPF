...
namespace YouTubeViewers.WPF.ViewModels
{
    public class YouTubeViewersListingViewModel : ViewModelBase
    {
        ...
        private void YouTubeViewersStore_YouTubeViewerDeleted(Guid id)
        {
            ...
            YouTubeViewer youTubeViewer = itemViewModel?.YouTubeViewer;

            if (itemViewModel != null)
            {
                youTubeViewer.Username = "del";
                itemViewModel?.Update(youTubeViewer);
        ...
        private void AddYouTubeViewer(YouTubeViewer youTubeViewer)
        {
            YouTubeViewersListingItemViewModel itemViewModel =
                new(youTubeViewer, _youTubeViewersStore, _modalNavigationStore);
